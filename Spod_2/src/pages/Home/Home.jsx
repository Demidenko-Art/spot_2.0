  ...
  return (
    <div className="home-page">
      <div className="home-header">
        <h1 className="home-logo">MELODY<span className="premium-dot">.</span></h1>
        <p className="home-sub">Твоя музика, твій вишуканий настрій</p>
      </div>

      {currentTrack && (
        <div className="now-playing-banner">
          <div className="banner-glow" style={{ backgroundImage: `url(${currentTrack.cover})` }}></div>
          <img src={currentTrack.cover} alt="" className="banner-img" />
